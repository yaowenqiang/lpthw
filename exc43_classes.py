...
class TheBridge(Scene):
    def enter(self):
        print(dedent("""
            You burst onto the Bridge with the return destruct bomb 
            under your arm and surprime 5 Gothons who are trying to
        ...
        if action == "throw the bomb":
            print(dedent("""
                ...
                shoots you right in the back killing you. As
                you die you see another Gothon frantically try to disarm 
                the bomb.You die knowing they will probably blow up when it 
                goes off.
            """))
            return "death!"
        elif action == "slowlyu place the bomb":
            print(dedent("""
                YOu point your blaster at the bomb under your arm and
                the Gothons put their hands up and start to sweet.
                You inch backwoard to the door.open it.and then
                carefully place the bomb on the floor.pointing your blaster 
                at it.You then jump back through the door.
                pounch the close button and blast the lock so the 
                Gothons can't get out.Now that the bomb is placed you run 
...
class EscapePod(Scene):
    def enter(self):
        print(dedent("""
            YOu rush through the ship desperately trying to make it ot
            the escape pod before the whole ship explodes.It seems 
            like hardly any Gothons are on the ship.so your run is 
            clear of interference. You get t`o the chamber with the escape pods.
        ...
        if int(guess) != good_pod:
            print(dedent("""
               ...
               impludes as the hull ruptures. crashing your body into jam jelly.
            """))
            return "death"
        else:
            print(dedent("""
               ...
               then explode like a bright start.taking out the Gothon ship at the 
               same time You won!
            """))
            return "finished"
